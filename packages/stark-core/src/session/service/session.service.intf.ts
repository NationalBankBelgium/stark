...
export interface StarkSessionService {
	 ...
	 *
	 * @returns {Observable} Observable that will emit the currentLanguage and the latest value whenever it changes
	 */
	 ...
	 *
	 * @param newLanguage {string} The language Id to be set
	 */
	 ...
	 * @param {StarkUser} user The user to log in.
	 */
