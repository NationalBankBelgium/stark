...
export class StarkPaginationMetadataImpl implements StarkPaginationMetadata {
	...
	@deserialize public limit: number;

	@deserialize public previousOffset: number;

	@deserialize public nextOffset: number;

	@deserialize public currentPage: number;

	@deserialize public pageCount: number;
