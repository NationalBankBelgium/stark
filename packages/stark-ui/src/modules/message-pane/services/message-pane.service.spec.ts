...
describe("Service: StarkMessagePaneService", () => {
	...
	describe("addOne", () => {
		it("should dispatch the GET_ALL_MESSAGES action and return the observable used to fetch the latest value of the starkMessages", () => {
