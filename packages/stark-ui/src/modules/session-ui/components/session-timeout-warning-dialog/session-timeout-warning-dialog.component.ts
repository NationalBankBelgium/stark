...
export class StarkSessionTimeoutWarningDialogComponent implements OnInit {
	...
	public keepSession(): void {
		this.dialogRef.close("keep-session");
	}

	/**
	 * This methods is used to close the dialog and to send an answer indicating that the user should be disconnected.
	 */
	public killSession(): void {
		this.dialogRef.close("kill-session");
	}
}
