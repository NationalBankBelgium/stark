...
export class StarkTableComponent<T extends object = {}>
	...
	implements OnInit, AfterViewInit, OnChanges, OnDestroy
{
	 ...
	 */
	@Input()
	public expandedRowFn: (expandedRow: T, row: T) => boolean = (expandedRow: T, row: T) => expandedRow === row;
	 ...
	 */
	public getUnmetFilterCriteria(item: T | string, filterCriteria: RegExp[]): RegExp[] {
		let itemStr: string;
