...
@Component({
	selector: "showcase-table-with-custom-cellclass-name",
	templateUrl: "./table-with-custom-cellclass-name.component.html",
	styleUrls: ["./table-with-custom-cellclass-name.component.scss"],
	animations: [
...
export class TableWithCustomCellclassNameComponent {
