...
@Component({
	...
	styleUrls: ["./demo-keyboard-directives-page.component.scss"],
	templateUrl: "./demo-keyboard-directives-page.component.html"
})
export class DemoKeyboardDirectivesPageComponent implements OnInit {
		...
		switch (paramValues[0]) {
			...
			case "input3":
				...
				if (paramValues.length === 5) {
					...
					const parentComponentContext: DemoKeyboardDirectivesPageComponent = paramValues[4];
