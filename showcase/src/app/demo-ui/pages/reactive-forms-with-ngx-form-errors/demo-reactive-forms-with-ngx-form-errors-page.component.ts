...
@Component({
	...
	templateUrl: "./demo-reactive-forms-with-ngx-form-errors-page.component.html",
	styleUrls: ["./demo-reactive-forms-with-ngx-form-errors-page.component.scss"]
})
export class DemoReactiveFormsWithNgxFormErrorsPageComponent implements OnInit {
