                ...
                <li class="chapter">
                                ...
                                <a href="modules/StarkSessionModule.html" data-type="entity-link">StarkSessionModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-StarkSessionModule-72144d1ed05f628c428dd9642c7a69fe"' : 'data-target="#xs-components-links-module-StarkSessionModule-72144d1ed05f628c428dd9642c7a69fe"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-StarkSessionModule-72144d1ed05f628c428dd9642c7a69fe"' :
                                            'id="xs-components-links-module-StarkSessionModule-72144d1ed05f628c428dd9642c7a69fe"' }>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/StarkPersistPreferredLanguageFailure.html" data-type="entity-link">StarkPersistPreferredLanguageFailure</a>
                            </li>
                            <li class="link">
